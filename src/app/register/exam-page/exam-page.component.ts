...
export class ExamPageComponent implements OnInit {
  ...
  constructor(private updatesevice: UpdateServiceService,
              private router: Router,
              public slectedExam: Exam) {}

  static result: {id: number, isAnswer1: number, isAnswer2: number, isAnswer3: number, isAnswer4: number}[];
...
//   }
  ...
  saveanswer(answers: Question): void {
    ...
    if ( Number(answers.isAnswer1) === this.question2.isAnswer1 && Number(answers.isAnswer2) === this.question2.isAnswer2
    && Number(answers.isAnswer3) === this.question2.isAnswer3 && Number(answers.isAnswer4) === this.question2.isAnswer4){
      this.finalResult++;
